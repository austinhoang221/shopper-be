...
internal static class SpecificationUtilities
{
    ...
    internal static IQueryable<TResponse> UseSpecification<TEntity, TResponse>(this IQueryable<TEntity> queryable,
        SpecificationWithMapping<TEntity, TResponse> specification)
        where TEntity : class, IEntityBase
    {
